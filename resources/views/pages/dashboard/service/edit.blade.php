                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <select id="revision_limit" name="revision_limit" autocomplete="revision_limit"
                                            ...
                                            <option value="2" {{ $service->revision_limit == '2' ? 'selected' : '' }}>2
                                                Revisi</option>
                                            <option value="5" {{ $service->revision_limit == '5' ? 'selected' : '' }}>4
                                                Revisi</option>
                                            <option value="7" {{ $service->revision_limit == '7' ? 'selected' : '' }}>8
                                                Revisi</option>
                                        ...
                                        <div class="grid grid-cols lg:grid-cols-3 md:grid-cols-2 gap-4">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input placeholder="Thumbnail" type="file"
                                                    name="{{ 'thumbnails['.$thumbnail_item->id.']' }}" id="thumbnails"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('addServicesRow').addEventListener('click', function() {
            ...
            newService.innerHTML = `
                <input placeholder="Keunggulan Service" type="text" name="advantage-service[]" id="advantage-service-${serviceCount}" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
        ...
        document.getElementById('addThumbnailRow').addEventListener('click', function() {
            ...
            newThumbnail.innerHTML = `
                <input placeholder="Thumbnail" type="file" name="thumbnail[]" id="thumbnail-${thumbnailCount}" autocomplete="thumbnail" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                <button type="button" class="inline-flex justify-center px-3 py-2 ml-3 text-xs font-medium text-red-500 border border-transparent rounded-lg hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 remove-row">
                    Hapus
                </button>`;
        ...
        document.getElementById('addAdvantagesRow').addEventListener('click', function() {
            ...
            newAdvantage.innerHTML = `
                <input placeholder="Keunggulan" type="text" name="advantage-user[]" id="advantage-user-${advantageCount}" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                <button type="button" class="inline-flex justify-center px-3 py-2 ml-3 text-xs font-medium text-red-500 border border-transparent rounded-lg hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 remove-row">
                    Hapus
                </button>`;
        ...
        document.getElementById('addTaglinesRow').addEventListener('click', function() {
            ...
            newTagline.innerHTML = `
                <input placeholder="Tagline" type="text" name="tagline[]" id="tagline-${taglinesCount}" autocomplete="taglines" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                <button type="button" class="inline-flex justify-center px-3 py-2 ml-3 text-xs font-medium text-red-500 border border-transparent rounded-lg hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 remove-row">
                    Hapus
                </button>`;
