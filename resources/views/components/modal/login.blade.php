        ...
        <div
            ...
            <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="inline-block text-xs text-gray-400">
                            <label class="inline-flex items-center mt-3">
                                <input type="checkbox" id="remember_me" name="remember"
                                    class="form-checkbox h-5 w-5 text-serv-button rounded border-serv-text">
                                <span class="ml-2 text-gray-400">Remember me</span>
                            </label>
                        </div>

                        <a href="{{ route('password.request') }}"
                            class="inline-block align-baseline text-xs text-serv-button mt-2 font-medium">
                            Forgot Password?
                        </a>
                    </div>
                </div>
                ...
                <div class="px-6 pb-6 rounded-b-xl mx-10">
                    ...
                    <p href="{{ route('index') }}" class="text-center py-5">
                        Dont have account? <a href="{{ route('index') }}" class="text-serv-button"
